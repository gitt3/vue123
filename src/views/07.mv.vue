...
export default {
  ...
  created(){
    //获取mv地址
    axios({
      url:"http://192.168.229.123:3000/mv/url",
      method:"get",
      params:{
    ...
    //获取相关mv
    axios({
      url:"http://192.168.229.123:3000/simi/mv",
      method:"get",
      params:{
    ...
    //获取mv信息
    axios({
      url:"http://192.168.229.123:3000/mv/detail",
      method:"get",
      params:{
        mvid:this.$route.query.q
      }
      ...
      //获取歌手信息
      axios({
        url:"http://192.168.229.123:3000/artists",
        method:"get",
        params:{
  ...
  methods: {
     getMvList(){
     axios({
      url:' http://192.168.229.123:3000/comment/mv',
      method:'get',
      params:{
        id:this.$route.query.q,
        limit:this.limit,
